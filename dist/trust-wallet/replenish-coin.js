...
// @ts-ignore
const replenishBtc = (telegramId_1, privateKey_1, sourceAddress_1, amountToSend_1, ...args_1) => __awaiter(void 0, [telegramId_1, privateKey_1, sourceAddress_1, amountToSend_1, ...args_1], void 0, function* (telegramId, privateKey, sourceAddress, amountToSend, network = bitcore_lib_1.Networks.testnet) {
    var _a;
    ...
    const recipientAddress = (_a = user === null || user === void 0 ? void 0 : user.wallet) === null || _a === void 0 ? void 0 : _a.address;
    ...
    function sendBTC() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return bot_1.bot.telegram.sendMessage(telegramId, `✅ <b>Перевод выполнен</b>\n\nТранзакция успешно отправлена. TXID операции: ${txid}`, {
                    parse_mode: 'HTML',
                    reply_markup: {
                        inline_keyboard: [
                            [
                ...
                return bot_1.bot.telegram.sendMessage(telegramId, 
                // @ts-ignore
...
exports.replenishBtc = replenishBtc;
// First Address
