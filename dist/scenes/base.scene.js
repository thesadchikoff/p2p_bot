...
exports.TransferScene = void 0;
const telegraf_1 = require("telegraf");
exports.TransferScene = new telegraf_1.Scenes.WizardScene('transfer', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(ctx.session);
        yield ctx.reply(`Укажите адрес кошелька, на который хотите вывести BTC.`);
